...
class TrustMonitorBase(app_manager.RyuApp):
    ...
    def __init_(self, app_name):
        super(TrustMonitorBase, self).__init__()
        self.name = app_name
    ...
    def publish_trust_update(self, trust_update):
        ...
        raise NotImplementedError('Subclasses must override send_trust_update_to_observers')
