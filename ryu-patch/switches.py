...
class Switches(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.is_active = True
        self.lldp_count_dict = {}		  # datapath_id => LLDPCounter	#TAG lldp count feature
    ...
    def _register(self, dp):
        ...
        self.dps[dp.id] = dp
        self.lldp_count_dict.setdefault(dp.id, LLDPCounter(dp.id))	#TAG lldp count feature
    ...
    def _unregister(self, dp):
        if dp.id in self.dps:
            ...
            del self.lldp_count_dict[dp.id]		#TAG lldp count feature
    ...
    def lldp_packet_in_handler(self, ev):
        ...
        try:
            ...
            self.lldp_count_dict[msg.datapath.id].rx_lldp += 1		#TAG lldp count feature
    ...
    def send_lldp_packet(self, port):
        ...
        if dp.ofproto.OFP_VERSION == ofproto_v1_0.OFP_VERSION:
            ...
            self.lldp_per_dp[dp.id] = 0		#TAG lldp count feature
        elif dp.ofproto.OFP_VERSION >= ofproto_v1_2.OFP_VERSION:
            actions = [dp.ofproto_parser.OFPActionOutput(port.port_no)]
            ...
            dp.send_msg(out)
            self.lldp_count_dict[dp.id].tx_lldp += 1	#TAG lldp count feature
        else:
